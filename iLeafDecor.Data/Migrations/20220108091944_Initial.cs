    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "vi", "Ngoại thất", "ngoai-that", "Sản phẩm ngoại thất", "Sản phẩm ngoại thất" },
                    { 3, 2, "vi", "Phòng ngủ", "phong-ngu", "Sản phẩm nội thất phòng ngủ", "Sản phẩm nội thất phòng ngủ" },
                    { 2, 1, "en", "Outdoors", "outdoors", "The products for outdoor decor", "The products for outdoor decor" },
                    { 4, 2, "en", "Bedroom", "bedroom", "The products for bedroom decor", "The products for bedroom decor" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Ghế treo hai chỗ ngồi ngoài trời - Màu xám", "Ghế treo hai chỗ ngồi ngoài trời - Màu xám", "vi", "Ghế treo hai chỗ ngồi ngoài trời - Màu xám", 1, "ghe-treo-hai-cho-ngoi-ngoai-troi", "Ghế treo hai chỗ ngồi ngoài trời - Màu xám", "Ghế treo hai chỗ ngồi ngoài trời - Màu xám" },
                    { 2, "Outdoor Two Seater Wicker Hanging Chair - Grey", "Outdoor Two Seater Wicker Hanging Chair - Grey", "en", "Outdoor Two Seater Wicker Hanging Chair - Grey", 1, "outdoor-two-seater-wicker-hanging-chair-grey", "Outdoor Two Seater Wicker Hanging Chair - Grey", "Outdoor Two Seater Wicker Hanging Chair - Grey" }
                });
